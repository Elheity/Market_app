...
class Products with ChangeNotifier{
  ...
  Future<void> fetchAndSetProduct ([bool filterByUser = false])async{
    ...
    var url = 'https://product-caa98-default-rtdb.firebaseio.com/products.json?auth$authToken&$filteredString';
    ...
    try{
      ...
      url = 'https://product-caa98-default-rtdb.firebaseio.com/userFavorites/$userId.json?auth$authToken';
  ...
  Future<void> addProducts(Product product)async{
    final url = 'https://product-caa98-default-rtdb.firebaseio.com/products.json?auth$authToken';
    try{
  ...
  Future<void> updateProduct(String id,Product newProduct)async{
    ...
    if(prodIndex >= 0){
      final url = 'https://product-caa98-default-rtdb.firebaseio.com/products/$id.json?auth$authToken';
  ...
  Future<void> deleteProduct(String id)async{
    ...
    if(res.statusCode >= 400){
      ...
      notifyListeners();
      throw HttpException('Connecting error');
    }
